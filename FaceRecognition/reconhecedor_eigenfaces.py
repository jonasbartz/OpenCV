...
#cap = cv2.VideoCapture('Jonas.mp4')
#cap = cv2.VideoCapture('Bruno.mp4')
cap = cv2.VideoCapture('JonasBruno.mp4')
...
while(cap.isOpened()):
    ...
    facesDetectadas = classificadorFace.detectMultiScale(gray, scaleFactor=2, minSize=(40,40), minNeighbors=3)
